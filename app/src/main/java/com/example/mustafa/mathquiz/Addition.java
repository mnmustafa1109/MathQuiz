...
public class Addition extends AppCompatActivity {
    ...
    public void displaying_button(int ans){
        ...
        if (main.getposition()==0) {
            if (button_number != 1) {
                display_button_1("" + (new Random().nextInt(20 - 6 + 1) + 6));
            }
            if (button_number != 2) {
                display_button_2("" + (new Random().nextInt(20 - 6 + 1) + 6));
            }
            if (button_number != 3) {
                display_button_3("" + (new Random().nextInt(20 - 6 + 1) + 6));
            }
            if (button_number != 4) {
                display_button_4("" + (new Random().nextInt(20 - 6 + 1) + 6));
            }
            if(button_number==1){
        ...
        if (main.getposition()==1) {
            if (button_number != 1) {
                display_button_1("" + (new Random().nextInt(80 - 50 + 1) + 50));
            }
            if (button_number != 2) {
                display_button_2("" + (new Random().nextInt(80 - 50 + 1) + 50));
            }
            if (button_number != 3) {
                display_button_3("" + (new Random().nextInt(80 - 50 + 1) + 50));
            }
            if (button_number != 4) {
                display_button_4("" + (new Random().nextInt(80 - 50 + 1) + 50));
            }
            if(button_number==1){
                int diff = new Random().nextInt(2 - 1 + 1) + 1;
                if(diff==1){
        ...
        if (main.getposition()==2) {
            if (button_number != 1) {
                display_button_1("" + (new Random().nextInt(170 - 120 + 1) + 120));
            }
            if (button_number != 2) {
                display_button_2("" + (new Random().nextInt(170 - 120 + 1) + 120));
            }
            if (button_number != 3) {
                display_button_3("" + (new Random().nextInt(170 - 120 + 1) + 120));
            }
            if (button_number != 4) {
                display_button_4("" + (new Random().nextInt(170 - 120 + 1) + 120));
            }
            if(button_number==1){
                int diff = new Random().nextInt(2 - 1 + 1) + 1;
                if(diff==1){
    ...
    public int question_generator() {
        ...
        if (main.getposition()==0){
            int numb1 = new Random().nextInt((20) + 1);
            int numb2 = new Random().nextInt((20) + 1);
            ...
            int numb1 = new Random().nextInt((50 - 20) + 1)+20;
            int numb2 = new Random().nextInt((50 - 20) + 1)+20;
            display_question(numb1 + " + " + numb2);
            answer = numb1 + numb2; }
        ...
        else {  int numb1 = new Random().nextInt((100 - 50) + 1)+50;
            int numb2 = new Random().nextInt((100 - 50) + 1)+50;
            display_question(numb1 + " + " + numb2);
            answer = numb1 + numb2;}
